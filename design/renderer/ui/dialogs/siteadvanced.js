...
const GAPS = {
  ...
  sftpListingQueue: 'Directory-listing pipelining is not configurable in this port’s SFTP engine. The value is stored and reported in the log.',
  ...
  ftpHost: 'Not yet threaded through to the FTP adapter. The value is stored; the HOST command is not sent today.',
    ...
    groups: [
      ...
      },
      {
        ...
        controls: [
          ...
          number('SFTPListingQueueEdit', 'sftpListingQueue', 'Listing pipelining depth:', { max: 256, gap: 'sftpListingQueue' }),
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        controls: [
          ...
          autoswitch('FtpHostCombo', 'ftpHost', 'Use HOST command to select host on the server', { gap: 'ftpHost' }),
