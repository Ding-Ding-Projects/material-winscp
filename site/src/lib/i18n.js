...
export const DICT = {
  ...
  downloadNone: [[
    'No published installer is available yet.',
    'No installer has been published yet.',
    'No installer to hand out yet — the build has not shipped.',
    'The installer table is empty: nothing has been published for this site to point at.',
    'Not a single installer in the pantry — nothing published yet, so this page refuses to invent a download link for you.'], [
    '仲未有已發佈嘅安裝檔。',
    '未有安裝檔發佈過。',
    '未有安裝檔派——個 build 未出街。',
    '安裝檔嗰欄空空如也：未有嘢發佈過，所以呢版冇嘢好指。',
    '櫃桶入面連一個安裝檔都冇——未發佈過，所以呢版死都唔會作個下載連結出嚟呃你。']],
