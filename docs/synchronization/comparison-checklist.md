...
Rows are grouped by action, and the group headers carry counts — so
"Delete remote (412)" is visible without scrolling to it.
...
| Select/deselect all in group | Drop an entire class of change. |
| Invert selection | |
